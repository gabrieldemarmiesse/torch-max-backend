...
variant = "4B"  # Options: "0.6B", "1.7B", "4B", "8B", "14B", "32B"
CONFIG = QWEN3_CONFIG_4B
model_name = f"Qwen/Qwen3-{variant}"
...
TEMPERATURE = 0.0
TOP_K = 1
repo_id = f"Qwen/Qwen3-{variant}"

filename = f"qwen3-{variant}.pth"
